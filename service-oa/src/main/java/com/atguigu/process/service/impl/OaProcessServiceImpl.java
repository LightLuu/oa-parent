...
public class OaProcessServiceImpl extends ServiceImpl<OaProcessMapper, Process> implements OaProcessService {
    ...
    public void startUp(ProcessFormVo processFormVo) {
        ...
        //3.1 新建一个process存储到业务表的类
        Process process = new Process();
        //processFormVo复制到process对象里面
        BeanUtils.copyProperties(processFormVo,process);
        //其他值
        process.setStatus(1); //审批中  //审批状态
    ...
    public IPage<ProcessVo> findfindPending(Page<Process> pageParam) {
        ...
        for(Task task : taskList) {
            ...
            if(process == null){
                System.out.println("process null 跳过");
                continue;
            }
    ...
    public Map<String, Object> show(Long id) {
        ...
        wrapper.eq(ProcessRecord::getProcessId,id).orderByDesc();
